...
let ResumeCommand = class ResumeCommand extends framework_1.Command {
    async chatInputRun(interaction) {
        ...
        player.pause(false);
        await interaction.reply({
            ephemeral: player.state !== lavacoffee_1.Utils.PlayerStates.Playing,
            embeds: [this.makeEmbed(player.state === lavacoffee_1.Utils.PlayerStates.Playing
                    ? "Resumed the player"
